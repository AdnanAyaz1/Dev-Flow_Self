...
const QuestionAnswerSelector = () => {
  ...
  return (
    <div className="my-[40px] flex rounded-xl body-medium">
      <div
        className={`rounded-tl-xl rounded-bl-xl px-[24px] py-[12px] cursor-pointer ${isActive == "questions" ? "bg-dark-400" : "bg-dark-300"} `}
      ...
      <div
        className={`rounded-tr-xl rounded-br-xl px-[24px] py-[12px] cursor-pointer ${isActive == "answers" ? "bg-dark-400" : "bg-dark-300"} `}
